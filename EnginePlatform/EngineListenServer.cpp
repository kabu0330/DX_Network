...
#include "EngineListenServer.h"
#include "TaskQueue.h"

UEngineListenServer::UEngineListenServer()
{
}
...
void UEngineListenServer::OpenServer(int _Port, int _BackLog)
{
    StartNetwork();
    ...
    ConnectAcceptThread.Start("ConnectAcceptThread", std::bind(&UEngineListenServer::AcceptThreadFunction, this, ListenSocket));

    SessionToken = SessionTokenCreator++;

}

void UEngineListenServer::AcceptThreadFunction(UEngineListenServer* _Server, SOCKET _ListenSocket)
{
...
void UEngineListenServer::SendPacket(UEngineProtocol* _Protocol)
{
    if (-1 == ListenSocket)
    {
        return;
...
void UEngineListenServer::Release()
{
